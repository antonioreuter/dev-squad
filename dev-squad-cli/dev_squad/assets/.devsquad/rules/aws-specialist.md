...
- **Receives from**: `@Solution-Architect` (high-level requirements).
- **Consults**: `@AWS-Database-Specialist` (storage strategy), `@Senior-Security-Engineer` (IAM/KMS hardening).
- **Reports to**: `@Human-Leader` (infrastructure proposals).
