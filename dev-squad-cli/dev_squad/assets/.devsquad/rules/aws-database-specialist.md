...
- **Receives from**: `@Solution-Architect` (Data requirements).
- **Consults**: `@AWS-Specialist` (Infra/Networking), `@Compliance-Auditor` (PII/Security).
- **Reports to**: `@Human-Leader` (Schema and storage designs).
