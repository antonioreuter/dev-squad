...
- **CloudWatch MCP Server**: Query logs, metrics, and manage alarms directly during incidents.
- **CloudWatch Application Signals MCP Server**: Configure and monitor SLOs and distributed tracing.
- **AWS IaC MCP Server**: Execute deployments (like CDK or Terraform builds).
- **AWS Network MCP Server**: Investigate VPCs, Security Groups, routing, and subnet isolation.
- **AWS CloudFormation MCP Server**: Debug precise drift and stack failures directly on deployment layers.
